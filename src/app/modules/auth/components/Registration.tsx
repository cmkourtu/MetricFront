...
import { getUserById, register } from '../core/_requests';
    ...
    onSubmit: async (values, { setStatus, setSubmitting }) => {
      ...
      try {
        ...
        if (auth) {
          ...
          const { data: user } = await getUserById(userId, jwtToken);
          setCurrentUser(user);
        }
      } catch (error) {
        console.error(error);
  ...
  return (
    ...
    >
      ...
      <div className="fv-row mb-8">
        <label className="form-label fw-bolder text-gray-900 fs-6 required">First name</label>
        <input
      ...
      <div className="fv-row mb-8">
        ...
        <label className="form-label fw-bolder text-gray-900 fs-6 required">Last name</label>
        <input
